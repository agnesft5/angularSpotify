(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VBibliotecaComponent = /** @class */ (function () {
                function VBibliotecaComponent(_data) {
                    this._data = _data;
                    this.songList = this._data.songList;
                }
                VBibliotecaComponent.prototype.ngOnInit = function () {
                };
                return VBibliotecaComponent;
            }());
            VBibliotecaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VPlayerComponent = /** @class */ (function () {
                function VPlayerComponent(_path, _data) {
                    this._path = _path;
                    this._data = _data;
                ...
                VPlayerComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this._path.url.subscribe(function (url) {
                        // Code to get the new notification data 
                        // and display it
                        _this.id = _this._path.snapshot.params.id;
                        _this.songList = _this._data.songList;
                        for (var _i = 0, _a = _this.songList; _i < _a.length; _i++) {
                            var song = _a[_i];
                            if (song["id"] == _this.id) {
                                _this.song = song;
                            }
            ...
            VPlayerComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/data.service */ "./src/app/services/data.service.ts");
            var VSongListComponent = /** @class */ (function () {
                function VSongListComponent(_data) {
                    this._data = _data;
                    this.songList = this._data.songList;
                }
                VSongListComponent.prototype.ngOnInit = function () {
                };
                return VSongListComponent;
            }());
            VSongListComponent.ctorParameters = function () { return [
                { type: _services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
            ]; };
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\agnes\Desktop\projectes\angularSpotify\angularSpotify\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
